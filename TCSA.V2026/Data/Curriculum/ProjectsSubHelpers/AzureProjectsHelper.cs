        ...
        return new List<Project>
        {
            ...
            new Project
            {
                ...
                Introduction = new List<Paragraph>
                {
                    new Paragraph
                    {
                        Body="Now that we know how to get around in Azure and <a href='project/47/deploying-simple-app'>deploy a static website</a>, it's time to take a step further and learn how to deploy a full-stack .NET solution, including creating an SQL Server in Azure."
                    },
                    new Paragraph
                    {
