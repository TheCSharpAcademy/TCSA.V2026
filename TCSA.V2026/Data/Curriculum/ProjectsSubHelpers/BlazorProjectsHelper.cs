    ...
    internal static List<Project> GetProjects()
    {
        return new List<Project>
        {
            ...
            new Project
            {
                ...
                BannerUrl = "pexels-football-wife-577822-1618269.jpg",
                LanguageHeadings = new EnglishHeadings(),
                ...
                Introduction = new List<Paragraph>
                {
                    new Paragraph
                    {
                        Body="You were hired by a sports club to build an application that will keep track of their teams statistics. They’ve tried several different apps but none was exactly what they wanted so decided to budget for an in-house developer. You’re lucky that your Blazor skills are now soaring and you’re ready to deliver. So far you have learned almost everything needed to fulfil the project's requisites. We will only add the ability to show data charts to help their coaches visualize the players performances. Let’s get started!"
                    }
                },
                Requirements = new List<string>
                {
                    ...
                    "The app will have a reports area in a different page showing the players statistics across multiple games. Coaches should be able to see detailed players information per game and per season. This area should contain bar charts with the player's performance.",
                    "The UI needs to contain a list of players with <b>at least five</b> parameters that will be tracked (i.e. passes, shots, rebounds, blocks, interceptions, in basketball).",
