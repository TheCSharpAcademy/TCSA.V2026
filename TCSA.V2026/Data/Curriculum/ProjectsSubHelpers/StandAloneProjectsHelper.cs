        ...
        return new List<Project>
        {
             new Project
             {
                ...
                Requirements = new List<string>
                {
                    ...
                    @$"Upon completion, you need to submit the link to your certificate (the one where we can actually see the certificate) in the dashboard</a>. If you encounter any problems, contact us <a target='_blank' href='{DiscordLink}'>via Discord, in the <b>#getting-help</b> channel</a>, along with the username/email you use to log into the academy."
                },
